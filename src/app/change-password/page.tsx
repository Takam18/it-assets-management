        ...
        <div className="login-right">
          ...
          <div className="login-form-container">
            <div className="login-header">
              ...
              <p>Your password has expired. Please update it to continue.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="login-input-wrap">
                ...
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: '0.5rem', lineHeight: '1.4' }}>
                  Must be at least 12 characters and contain: 1 uppercase, 1 lowercase, 1 number, and 1 special character. Cannot be one of your last 3 passwords.
                </div>
              </div>
